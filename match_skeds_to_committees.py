...
COMMITTEE_FILES = ['data/24/cm.txt', 'data/22/cm.txt', 'data/20/cm.txt', 'data/18/cm.txt', 'data/16/cm.txt', 'data/14/cm.txt', 'data/12/cm.txt', 'data/10/cm.txt', 'data/08/cm.txt']
CANDIDATE_FILES = ['data/24/cn.txt', 'data/22/cn.txt', 'data/20/cn.txt', 'data/18/cn.txt', 'data/16/cn.txt', 'data/14/cn.txt', 'data/12/cn.txt', 'data/10/cn.txt', 'data/08/cn.txt']
